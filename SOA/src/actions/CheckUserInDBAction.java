...
public class CheckUserInDBAction extends AbstractActionLifecycle {
    protected ConfigTree  _config;

    public CheckUserInDBAction(ConfigTree config) {
        _config = config;
    }
	...
	public Message process(Message message) throws Exception {
        ...
        System.out.println("[CheckUserInDBAction] Incoming user nick : " + request.getNick());
        ...
        System.out.println("[CheckUserInDBAction] Outgoing User id : "+retUser.getId());
	...
	public static User getUser(User user){
		...
		while(itr.hasNext()){
			...
			if (user.getNick().trim().equals(us.getNick().trim())) {
				retUser = user;
				break;
			}
		}

...
public class AddConferenceToUserFavsAction extends AbstractActionLifecycle {
	...
	public Message process(Message message) throws Exception {
        ...
        System.out.println("[AddConferenceToUserFavsAction] Incoming conference id : " + conferenceid);
        System.out.println("[AddConferenceToUserFavsAction] Incoming user id : " + userid);
        ...
        System.out.println("[AddConferenceToUserFavsAction] AddConferenceToUserFavsAction response");
